/**
 * N2 漢字 JSON に Tanaka Corpus の A 例文を最大4つ付与
 */

import fs from "fs";

// ===== PATH =====
const KANJI_PATH = "src/data/kanji/n2.json";
const CORPUS_PATH = "corpus/tanaka.txt";
const OUTPUT_PATH = "src/data/kanji/n2_with_examples.json";
...
console.log(`✅ N2 例文付与完了: ${attached} 漢字`);
